...
class ResCompany(models.Model):
    ...
    taux_cnps_employe_expat = fields.Float('Taux CNPS employé expatrié')
    ...
    max_assiette_cnps = fields.Float("Plafond regime de retraite mensuel", default=3375000)
    max_assiette_autre_contribution = fields.Float("Plafond regime autres contributions", default=75000)
