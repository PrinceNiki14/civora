...
class HrPayrollPayrollWizardXlsx(models.AbstractModel):
    _name = 'report.hr_cgrae.report_hr_cgrae_xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, objs):
        for obj in objs:
            ...
            sheet = workbook.add_worksheet("Rapport cotisation CGRAE")
            ...
            docs = self.env['hr.cgrae'].browse(ids)
            self.formatSheet(sheet)
            sheet.write(0, 0, "Rapport cotisation CGRAE", header_format)
