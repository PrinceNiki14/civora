  ...
  reutilisant le kit de composants de civora_core.
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'civora_contacts/static/src/contacts/rgpd_imports.scss',
            'civora_contacts/static/src/contacts/analytics.scss',
            ...
            'civora_contacts/static/src/contacts/rgpd_view.js',
            'civora_contacts/static/src/contacts/rgpd_view.xml',
            'civora_contacts/static/src/contacts/imports_view.js',
            'civora_contacts/static/src/contacts/imports_view.xml',
            'civora_contacts/static/src/contacts/scoring_view.js',
            'civora_contacts/static/src/contacts/scoring_view.xml',
            'civora_contacts/static/src/contacts/interactions_view.js',
            'civora_contacts/static/src/contacts/interactions_view.xml',
